...
export default function AuthForm() {
  ...
  const { verifyApiKey, status, isLoginModalOpen, setIsLoginModalOpen, isApiKeyModalOpen, setIsApiKeyModalOpen } = useAuth();
  ...
  return (
    <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="apiKey" className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-2">
                    目前处于<span className="text-orange-500">演示</span>模式。请输入您的 StyleGen API_KEY，以解锁<span className="text-orange-500">智能</span>风格转换引擎
                  </Label>
                  <Input
                    id="apiKey"
                    name="apiKey"
      ...
      <Dialog open={isApiKeyModalOpen} onOpenChange={setIsApiKeyModalOpen}>
        <DialogContent className="max-w-md mx-auto rounded-lg shadow-xl p-8 text-center">
          <DialogTitle className="text-xl font-bold mb-6 text-gray-900 dark:text-white">
            购买渠道构建中，敬请期待...
          </DialogTitle>
